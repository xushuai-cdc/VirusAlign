...
# ======================== Main Interface ========================
st.markdown(
    '<h1 style="color:#003680;font-size:5.2rem;font-weight:900;margin-bottom:2px;text-align:center;'
    'font-family:Source Sans Pro,sans-serif">VirusAlign</h1>'
    '<p style="color:#222;font-size:1.5rem;margin-top:0;margin-bottom:20px;text-align:center;'
...
with c1:
    st.markdown(
        '<div style="background:#F0F7FF;padding:12px 16px;border-radius:8px;border-left:4px solid #003680;font-size:1.05rem">'

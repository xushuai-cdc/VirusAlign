...
with st.sidebar:
    ...
    st.divider()
    st.markdown("### Global Priority Pathogens (ICTV Verified)")
    ...
    pathogens = [
        ...
        ("小核糖核酸病毒科 (Picornaviridae)", "脊髓灰质炎 (PV), 鼻病毒, 手足口病 (EV-A71/CA16)"),
        ("逆转录病毒科 (Retroviridae)", "艾滋病毒 (HIV-1/2), 人类T细胞白血病病毒 (HTLV)"),

...
# ======================== Main Interface ========================
st.markdown(
    '<h1 style="color:#003680;font-size:4.2rem;font-weight:900;margin-bottom:2px;'
    'font-family:Source Sans Pro,sans-serif">VirusAlign</h1>'
    '<p style="color:#222;font-size:1.15rem;margin-top:0;margin-bottom:20px;'
...
# ===== Tab 1: Quick Lookup =====
with tab1:
    st.markdown("**Find the Standard Species**")

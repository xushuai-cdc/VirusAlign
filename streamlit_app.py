...
/* Overall base sizing */
    html, body, .stApp, .stMarkdown, .stTextInput, .stSelectbox, .stButton, .stAlert {
        font-size: 18px;
    }
...
# ======================== Main Interface ========================
st.markdown(
    '<h1 style="color:#003680;font-size:4.2rem;font-weight:900;margin-bottom:2px;text-align:center;'
    'font-family:Source Sans Pro,sans-serif">VirusAlign</h1>'
    '<p style="color:#222;font-size:1.3rem;margin-top:0;margin-bottom:20px;text-align:center;'
...
# ===== Tab 1: Quick Lookup =====
with tab1:
    st.markdown("<h3 style='text-align:center;color:#000;font-size:2rem'>Find the Standard Species</h3>", unsafe_allow_html=True)
    st.caption("Identify current official taxon names by searching with virus names, common abbreviations, isolate names, or NCBI Taxonomy IDs.")
    st.caption("(支持通过病毒名称、常用缩写、分离株名或NCBI分类ID识别标准化物种)")
    ...
    st.markdown("**Try Samples (点击直接体验):**")

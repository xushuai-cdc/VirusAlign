...
with st.sidebar:
    ...
    st.divider()
    st.markdown("### Global Priority Pathogens")
    st.caption("System covers ALL 17,554 ICTV species (MSL41). List below shows high-priority groups for this project.")
    pathogens = [
        ("冠状病毒科 (Coronaviridae)", "SARS-CoV-2, MERS-CoV, SARS-CoV"),
        ("正粘病毒科 (Orthomyxoviridae)", "甲/乙型流感病毒 (Flu A/B)"),
        ("黄病毒科 (Flaviviridae)", "登革 (DENV), 寨卡 (ZIKV), 乙脑, 丙肝 (HCV)"),
        ("布尼亚病毒目 (Bunyavirales)", "发热伴血小板综合征 (SFTSV), 汉坦病毒"),
        ("副黏病毒科 (Paramyxoviridae)", "尼帕病毒 (NiV), 麻疹, 腮腺炎, RSV"),
        ("丝状病毒科 (Filoviridae)", "埃博拉 (Ebola), 马尔堡病毒"),
        ("小核糖核酸病毒科 (Picornaviridae)", "脊灰, 鼻病毒, 手足口 (EV-71/A16)"),
        ("逆转录病毒科 (Retroviridae)", "艾滋病毒 (HIV-1/2)"),
        ("疱疹病毒科 (Herpesviridae)", "HSV-1/2, VZV, EBV, CMV"),
        ("肝病毒科 (Hepadnaviridae)", "乙肝病毒 (HBV)"),
        ("披盖病毒科 (Togaviridae)", "基孔肯雅病毒 (CHIKV), 风疹"),
        ("痘病毒科 (Poxviridae)", "猴痘 (Mpox), 牛痘, 天花"),
        ("弹状病毒科 (Rhabdoviridae)", "狂犬病毒 (Rabies)"),
        ("杯状病毒科 (Caliciviridae)", "诺如病毒 (Norovirus)"),
        ("呼肠孤病毒科 (Reoviridae)", "轮状病毒 (Rotavirus)"),
        ("其他高风险类", "乳头瘤 (HPV), 腺病毒, 星状病毒, 多瘤病毒"),
    ]
